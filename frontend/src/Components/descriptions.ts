export const descriptions = {
  ...
  Health:
    "Health includes any budget spending on healthcare programs, public health initiatives, and medical research. The Affordable Care Act (ACA) expanded access to health insurance, Medicaid, and Medicare, and established health insurance marketplaces. The ACA also included provisions for preventive care, mental health services, and coverage for pre-existing conditions, influencing how federal income taxes are used to support healthcare programs.",
  "Income Security":
    "Income security programs provide financial assistance to individuals and families in need. These programs include Social Security, Supplemental Security Income (SSI), unemployment insurance, and other safety net programs. Federal income taxes support income security programs by providing funding for benefits and services to eligible recipients.",
    "General Science, Space, and Technology": "The National Aeronautics and Space Administration (NASA) is the primary agency responsible for the U.S. space program, scientific research, and technological innovation. NASA conducts space exploration missions, scientific research, and technology development, funded by federal income taxes. The agency collaborates with international partners, private companies, and academic institutions to advance scientific knowledge and technological capabilities.",
};
